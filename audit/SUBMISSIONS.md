...
|---|---|---|---|
| B1 | Repo not public — no git remote configured; GitHub repo must be created public with LICENSE visible (FASE 0 stop condition, still open) | **OPEN** | user |
