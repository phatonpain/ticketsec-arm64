...
## Gate evidence
- Última execução verde para G1–G4 e G6: `TEST_RESULTS_v4.md` §2026-07-20 04:03:56Z.
- **G5 e G7 estão como STUB (não verificado)** — ver `audit/CORRECTION_G5_G7_STUB.md`.
- G8 agora exclui arquivos de evidência de gates (`TEST_RESULTS_*.md`, `audit/evidence/*`) para evitar o loop evidência-versus-limpeza.
...
## Correções pós-auditoria (MASTER_PROMPT + ANALISE_PROFUNDA)
- Skills migradas de `.kimi/skills/` para `.kimi-code/skills/` e alinhadas com os templates 2026.
- `scripts/gates.sh` atualizado com G0 (detecção de stub) e G8 anti-loop.
- `audit/CORRECTION_G5_G7_STUB.md` documenta o erro dos stubs sem reescrever histórico git.
...
- G5/G7 são stubs — preencher antes de P2; enquanto forem stubs, `bash scripts/gates.sh` reporta STUB e sai não-zero.
