 ...
 * extractLatencySeries / extractThroughputSeries, cn.
 */
...
describe('truncate', () => {
  ...
  it(
    'EXPOSED-04: truncate iterates code points — does not split surrogate pairs on astral chars',
    () => {
      // '🚨' is 2 UTF-16 units; the fixed implementation counts code points.
