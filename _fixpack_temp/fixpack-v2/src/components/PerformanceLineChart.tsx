        ...
        {loaded && data.length === 0 ? (
          ...
          >
            ...
            <span style={{ fontSize: 'var(--font-size-micro, 11px)', color: 'var(--text-muted)', lineHeight: 1.5 }}>
              Accuracy history is served by the inference API. The API is currently offline and the cache holds no
              performance points. This chart populates automatically when the API reconnects — no action needed.
            </span>
          </div>
        ) : null}
