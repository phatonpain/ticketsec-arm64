        ...
        {tiles.map(tile => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
              <tile.icon size={12} color="var(--text-muted)" />
              <span
                style={{
            ...
            <div
              style={{
                ...
                fontWeight: 600,
                color: tile.value === '—' ? 'var(--text-muted)' : 'var(--text-primary)',
            ...
            <div style={{ fontSize: 'var(--font-size-micro, 11px)', color: 'var(--text-muted)' }}>{tile.sub}</div>
          </div>
        ))}
      </div>
      <div
